...
param nestedvirtuaVnetAddressSpace string = '10.100.0.0/24'
param nestedvirtuaDefaultSubnet string = '10.100.0.0/24'
...
module diagnosticstorageaccount './modules/strgaccount.bicep' = {
